...
for i in range(epoch): #epoch
    ...
    for mini in range(batch_num):
        ...
        #encd_neg = unrefer_pos_model(neg_src, neg_src_len, neg_tar, neg_tar_len)
...
torch.save(unrefer_pos_model, 'result/positive_model.th')
torch.save(unrefer_neg_model, 'result/negative_model.th')

#unrefer_pos_model = torch.load('result/positive_model.th')
#unrefer_neg_model = torch.load('result/negative_model.th')
